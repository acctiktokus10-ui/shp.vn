        ...
        <div className="card">
          {isExpiredRedirect && (
            <div style={{
              ...
              background: "#fff4e0", border: "2px solid #ffd699",
              borderRadius: 12, color: "#b7791f", fontSize: 13, fontWeight: 700,
              textAlign: "center",
            }}>
              ⏰ Link bạn vừa dùng đã hết hạn (quá 30 phút). Hãy tạo link mới nhé!
            </div>
          )}
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <button
              className="btn-main"
              style={{ flex: 1, width: "auto", margin: 0, background: "linear-gradient(135deg,#ff4d6d,#c9184a)" }}
          ...
          {showQR && (
            ...
            >
              ...
              >
                <p style={{ fontSize: 15, fontWeight: 800, color: "#ff4d6d", marginBottom: 10 }}>
                  📱 Quét mã để mua gói VIP
                </p>
                <img
                  src="/zalo-qr.png"
                  alt="QR Zalo Meozz"
                  style={{ width: "100%", borderRadius: 12, border: "2px solid #ffd6e0" }}
                />
                <p style={{ fontSize: 12, color: "#888", marginTop: 10 }}>
                  Mở app Zalo → quét mã này để kết bạn và thanh toán
                </p>
                <button
                  className="btn-main"
                  style={{ marginTop: 14 }}
